    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="">Go-Mput</a>
        </div>
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/bar-bar.png');"></div>
                <div class="carousel-caption">
                    <h2>Catering lengkap dengan harga murah ya hanya di Go-Mput</h2>
                </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/kuda.png');"></div>
                <div class="carousel-caption">
                    <h2>Menyediakan berbagai macam menu catering siap antar</h2>
                </div>
            </div> 
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'assets/img/bar-bar.png'; ?>" width="100%"><br><br>
				<img src="<?php echo $url.'assets/img/kuda.png'; ?>" width="100%">
			</div>
		</div>